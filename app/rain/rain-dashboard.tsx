      ...
      <section className="workspace rain-workspace">
        ...
        <aside className="insights rain-insights" aria-label="สรุปพยากรณ์ฝนวันที่เลือก">
          ...
          <div className="forecast-note rain-forecast-note">
            ...
            <p><b>สรุปวันที่เลือก</b>{day?.probabilityMax === null ? "ยังโหลดข้อมูลไม่ได้" : `โอกาสฝนสูงสุด ${day.probabilityMax}% และฝนเฉลี่ย ${day.rainMeanMm ?? "—"} มม.${highestPoint ? ` พื้นที่แบบจำลองที่ควรติดตามคือ${highestPoint.label}` : ""}`}</p>
          </div>
        </aside>
      </section>
    </main>
